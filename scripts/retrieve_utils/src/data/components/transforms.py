...
def default_vocab_transform(is_remove=True, is_standardize=True, is_filter=True, min_count=2) -> TextCompose:
    ...
    if is_filter:
        transforms.append(FrequencyMinWordCount(min_count=min_count))
